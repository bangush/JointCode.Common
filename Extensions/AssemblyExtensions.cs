...
//        /// <see href="SetCustomAttribute"/> of the given <paramref name="attributeType"/>.
//        /// </summary>
...
//        /// <summary>
//        /// Gets all types in the given <paramref name="assembly"/> that are decorated with an
//        /// <see href="SetCustomAttribute"/> of the given type <typeparamref name="T"/>.
//        /// </summary>
//        /// <returns>A list of all matching types. This value will never be null.</returns>
//        public static IList<Type> TypesWith<T>( this Assembly assembly ) where T : SetCustomAttribute
//        {
