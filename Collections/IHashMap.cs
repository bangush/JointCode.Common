...
#endif
{
    ...
    /// </summary>
    public interface IHashMap : IEnumerable
	{
		/// <summary>
		...
		/// </summary>
		bool TryGetOrAdd(object key, object value, out object oldValue);
		...
		/// </summary>
		bool TryGetAndRemove(object key, out object value);
		...
		/// otherwise.
		/// </summary>
		bool TryGetAndAddOrReplace(object key, object value, out object oldValue);
		...
		/// </summary>
		object GetOrCreate(object key, Delegate createValue);
		...
		/// locks taken.
		/// </summary>
		void AddMany(ICollection pairs);
		...
		IHashMap
	{
		...
		/// or because the item already existed.
		/// </summary>
		TValue GetOrCreate(TKey key, MyFunc<TKey, TValue> createValue);
		...
		/// If you simple want to get a value, be it old or new, use GetOrAdd.
		/// </summary>
		bool TryGetOrAdd(TKey key, TValue value, out TValue oldValue);
		...
		/// otherwise.
		/// </summary>
		bool TryGetAndAddOrReplace(TKey key, TValue value, out TValue oldValue);
		...
		/// locks taken.
		/// </summary>
		void AddMany(ICollection<KeyValuePair<TKey, TValue>> pairs);
